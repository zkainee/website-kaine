<?php
$portfolioWindow = '<div class="">
    <div class="window" style="width: 400px">
        <div class="title-bar">
            <div class="title-bar-text">Portfolio | Kaine</div>
        ...
        <div class="window-body">
            <menu role="tablist">
                <button aria-selected="true" aria-controls="music">Lorem</button>
                <button aria-controls="dogs">Ipsum</button>
                <button aria-controls="food">Dolor</button>
            </menu>
            <article role="tabpanel" id="music">
                <p>Lorem ipsum dolor sit amet</p>
                <fieldset>
                    <legend>Todays mood</legend>
                    <div class="field-row">
                        <input id="radio29" type="radio" name="fieldset-example2">
                        <label for="radio29">LOREM IPSUM</label>
                    </div>
                    <div class="field-row">
                        <input id="radio30" type="radio" name="fieldset-example2">
                        <label for="radio30">LOREM IPSUM</label>
                    </div>
                    <div class="field-row">
                        <input id="radio31" type="radio" name="fieldset-example2">
                        <label for="radio31">LOREM IPSUM</label>
                    </div>
                    <div class="field-row">
                        <input id="radio32" type="radio" name="fieldset-example2">
                        <label for="radio32">LOREM IPSUM</label>
                    </div>
                </fieldset>
